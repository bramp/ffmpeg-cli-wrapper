...
public class FFmpegBuilderTest {
  ...
  public void testNormal() {
    ...
    assertThat(args, contains("-y", "-v", "debug", "-ss", "00:00:01.500", "-i", "input",
  ...
  public void testFilter() {
    ...
    assertThat(args, contains("-y", "-v", "error", "-i", "input", "-vf",
  ...
  public void testFilterAndScale() {
    ...
    assertThat(args, contains("-y", "-v", "error", "-i", "input", "-s", "320x240", "-vf",
  ...
  public void testMultipleOutputs() {
    ...
    assertThat(args, contains("-y", "-v", "error", "-i", "input", "-s", "320x240",
  ...
  public void testMetaTagsWithSpecifier() {
    ...
    assertThat(args, contains("-y", "-v", "error", "-i", "input", "-metadata",
  ...
  public void testExtraArgs() {
    ...
    assertThat(args, contains("-y", "-v", "error", "-a", "b", "-i", "input", "-an", "-sn",
        "-c", "d", "output"));
  }
