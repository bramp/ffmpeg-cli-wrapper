...
public abstract class AbstractFFmpegOutputBuilderTest extends AbstractFFmpegStreamBuilderTest {
  ...
  public void testConstantRateFactor() {
    List<String> command = getBuilder().setConstantRateFactor(5).build(0);
  ...
  public void testAudioSampleFormat() {
    List<String> command = getBuilder().setAudioSampleFormat("asf").build(0);
  ...
  public void testAudioBitrate() {
    List<String> command = getBuilder().setAudioBitRate(1_000).build(0);
  ...
  public void testAudioQuality() {
    List<String> command = getBuilder().setAudioQuality(5).build(0);
  ...
  public void testSetAudioBitStreamFilter() {
    List<String> command = getBuilder().setAudioBitStreamFilter("filter").build(0);
  ...
  public void testSetVideoBitRate() {
    List<String> command = getBuilder().setVideoBitRate(1_000_000).build(0);
  ...
  public void testSetVideoQuality() {
    List<String> command = getBuilder().setVideoQuality(20).build(0);
  ...
  public void testSetVideoPreset() {
    List<String> command = getBuilder().setVideoPreset("main").build(0);
  ...
  public void testSetVideoFilter() {
    List<String> command = getBuilder().setVideoFilter("filter").build(0);
  ...
  public void testSetVideoBitStreamFilter() {
    List<String> command = getBuilder().setVideoBitStreamFilter("bit-stream-filter").build(0);
  ...
  public void testSetComplexFilter() {
    List<String> command = getBuilder().setComplexFilter("complex-filter").build(0);
