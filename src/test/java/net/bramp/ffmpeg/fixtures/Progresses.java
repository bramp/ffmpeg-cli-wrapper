...
public final class Progresses {
  ...
  public static final ImmutableList<String> allFiles =
      ImmutableList.of("ffmpeg-progress-0", "ffmpeg-progress-1", "ffmpeg-progress-2", "ffmpeg-progress-3");
  ...
  public static final ImmutableList<Progress> allProgresses =
      ImmutableList.of(
          ...
          new Progress(42, 23.1f, 1935500, 1285168, 4123000000L, 0, 0, 0.929f, Progress.Status.CONTINUE));
}
