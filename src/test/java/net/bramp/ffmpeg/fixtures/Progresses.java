...
public final class Progresses {
  ...
  public static final ImmutableList<Progress> naProgresses =
      ImmutableList.of(
          new Progress(0, Fraction.getFraction(0.0f), -1, -1, -1, 0, 0, -1, Progress.Status.END));

  public static final ImmutableList<String> malformedProgressFile =
      ImmutableList.of("ffmpeg-progress-malformed");

  public static final ImmutableList<Progress> malformedProgresses =
      ImmutableList.of(new Progress(-1, null, 1935500, -1, 522000000000L, -1, -1, 0.929f, null));
}
