...
public final class ChannelLayouts {
  ...
  private static final IndividualChannel FRC =
      new IndividualChannel("FRC", "front right-of-center");
  ...
  private static final IndividualChannel SDR =
      new IndividualChannel("SDR", "surround direct right");
  ...
  public static final ImmutableList<ChannelLayout> CHANNEL_LAYOUTS =
      new ImmutableList.Builder<ChannelLayout>()
          .add(
              ...
              new StandardChannelLayout(
                  "7.1(wide)", decomposition(FL, FR, FC, LFE, BL, BR, FLC, FRC)),
              new StandardChannelLayout(
                  "7.1(wide-side)", decomposition(FL, FR, FC, LFE, FLC, FRC, SL, SR)),
              new StandardChannelLayout(
                  "7.1(top)", decomposition(FL, FR, FC, LFE, BL, BR, TFL, TFR)),
              ...
              new StandardChannelLayout(
                  "22.2",
                  decomposition(
                      FL, FR, FC, LFE, BL, BR, FLC, FRC, BC, SL, SR, TC, TFL, TFC, TFR, TBL, TBC,
                      TBR, LFE2, TSL, TSR, BFC, BFL, BFR)))
          .build();
